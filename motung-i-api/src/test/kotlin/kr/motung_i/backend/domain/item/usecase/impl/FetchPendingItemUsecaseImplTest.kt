...
class FetchPendingItemUsecaseImplTest {
    @Mock
    private lateinit var itemRepository: ItemRepository

    @InjectMocks
    private lateinit var fetchPendingItemUsecaseImpl: FetchPendingItemUsecaseImpl
    ...
    fun 꿀템을_조회하면_올바른_DTO_형식으로_반환한다() {
        ...
        val result = fetchPendingItemUsecaseImpl.execute()
