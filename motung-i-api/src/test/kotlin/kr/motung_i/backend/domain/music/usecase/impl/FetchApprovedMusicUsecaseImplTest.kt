...
class FetchApprovedMusicUsecaseImplTest {
    @Mock
    private lateinit var musicRepository: MusicRepository

    @InjectMocks
    private lateinit var fetchApprovedMusicUsecaseImpl: FetchApprovedMusicUsecaseImpl
    ...
    fun 노래를_조회하면_올바른_DTO_형식으로_반환한다() {
        ...
        val result = fetchApprovedMusicUsecaseImpl.execute()
