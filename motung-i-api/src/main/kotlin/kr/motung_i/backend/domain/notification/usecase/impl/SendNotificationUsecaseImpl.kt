package kr.motung_i.backend.domain.notification.usecase.impl
...
class SendNotificationUsecaseImpl(
    ...
    override fun execute(request: SendNotificationRequest) {
        ...
        val logger: Logger = LoggerFactory.getLogger(SendNotificationUsecaseImpl::class.java)
